...
class FA18Handler:
    ...
    def __init__(self, displayHandler, parser):
        ...
        self.bufferScratchpadString1Display = StringBuffer(parser, 0x744e  , 2, lambda s: self.setData(1,s))
        self.bufferScratchpadString2Display = StringBuffer(parser, 0x7450  , 2, lambda s: self.setData(2,s))
        self.bufferScratchpadNumberDisplay = StringBuffer(parser, 0x7446  , 8, lambda s: self.setData(3,s))
        self.bufferOptionDisplay1 = StringBuffer(parser, 0x7432    , 4, lambda s: self.setData(11,s))
        self.bufferOptionDisplay2 = StringBuffer(parser, 0x7436    , 4, lambda s: self.setData(12,s))
        self.bufferOptionDisplay3 = StringBuffer(parser, 0x743a    , 4, lambda s: self.setData(13,s))
        self.bufferOptionDisplay4 = StringBuffer(parser, 0x743e   , 4, lambda s: self.setData(14,s))
        self.bufferOptionDisplay5 = StringBuffer(parser, 0x7442   , 4, lambda s: self.setData(15,s))
        self.bufferCOMM1Display = StringBuffer(parser, 0x7424   , 2, lambda s: self.setData(21,s))
        self.bufferCOMM2Display = StringBuffer(parser, 0x7426   , 2, lambda s: self.setData(22,s))
        self.bufferOptionCueing1 = StringBuffer(parser, 0x7428   , 1, lambda s: self.setData(31,s))
        self.bufferOptionCueing2 = StringBuffer(parser, 0x742a   , 1, lambda s: self.setData(32,s))
        self.bufferOptionCueing3 = StringBuffer(parser, 0x742c   , 1, lambda s: self.setData(33,s))
